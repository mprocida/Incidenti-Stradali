...
class IncidentiMetaBoxes {
    ...
    * Lista delle Polizie Municipali della provincia di Lecce
    ...
    private function render_single_veicolo_fields($post, $veicolo_num) {
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" id="<?php echo $prefix; ?>targa" name="<?php echo $prefix; ?>targa" value="<?php echo esc_attr($targa); ?>" maxlength="8">
                </td>
            </tr>
            <tr>
    ...
    /**
     * Nasconde elementi UI aggiuntivi per utenti Asset e Supervisor
     */
