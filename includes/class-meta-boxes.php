...
class IncidentiMetaBoxes {
    ...
    public function __construct() {
        ...
        add_action('wp_ajax_stampa_modulo_pdf', array($this, 'handle_stampa_modulo_pdf'));
    }
    ...
    public function add_meta_boxes() {
        ...
        // Meta box per operazioni
        add_meta_box(
            'incidente_operazioni',
            __('Operazioni', 'incidenti-stradali'),
            array($this, 'render_operazioni_meta_box'),
            'incidente_stradale',
            'side',
            'high'
        );
    ...
    <div class="incidenti-nominativi-container">
        <p class="description">
            <?php _e('Nome e Cognome dei morti coinvolti nell\'incidente', 'incidenti-stradali'); ?>
        </p>
        <div id="nominativi-morti-container">
            ...
            <div id="morto-<?php echo $i; ?>" class="nominativo-morto" style="display: none; margin-bottom: 15px; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                <h5>
                    <?php printf(__('Morto %d', 'incidenti-stradali'), $i); ?>
                </h5>
                <table class="form-table">
                    <tr>
                        <th><label for="morto_<?php echo $i; ?>_nome">
                                <?php _e('Nome', 'incidenti-stradali'); ?></label></th>
                        <td>
                            <input type="text" id="morto_<?php echo $i; ?>_nome" name="morto_<?php echo $i; ?>_nome" value="<?php echo esc_attr(get_post_meta($post->ID, 'morto_' . $i . '_nome', true)); ?>" class="regular-text" maxlength="30">
                        </td>
                    </tr>
                    <tr>
                        <th><label for="morto_<?php echo $i; ?>_cognome">
                                <?php _e('Cognome', 'incidenti-stradali'); ?></label></th>
                        <td>
                            <input type="text" id="morto_<?php echo $i; ?>_cognome" name="morto_<?php echo $i; ?>_cognome" value="<?php echo esc_attr(get_post_meta($post->ID, 'morto_' . $i . '_cognome', true)); ?>" class="regular-text" maxlength="30">
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <p class="description">
            <?php _e('Nome e Cognome dei feriti coinvolti nell\'incidente', 'incidenti-stradali'); ?>
        </p>
        <div id="nominativi-feriti-container">
            ...
            <div id="ferito-<?php echo $i; ?>" class="nominativo-ferito" style="display: none; margin-bottom: 15px; padding: 10px; border: 1px solid #ddd; border-radius: 4px;">
                <h5>
                    <?php printf(__('Ferito %d', 'incidenti-stradali'), $i); ?>
                </h5>
                <table class="form-table">
                    <tr>
                        <th><label for="ferito_<?php echo $i; ?>_nome">
                                <?php _e('Nome', 'incidenti-stradali'); ?></label></th>
                        <td>
                            <input type="text" id="ferito_<?php echo $i; ?>_nome" name="ferito_<?php echo $i; ?>_nome" value="<?php echo esc_attr(get_post_meta($post->ID, 'ferito_' . $i . '_nome', true)); ?>" class="regular-text" maxlength="30">
                        </td>
                    </tr>
                    <tr>
                        <th><label for="ferito_<?php echo $i; ?>_cognome">
                                <?php _e('Cognome', 'incidenti-stradali'); ?></label></th>
                        <td>
                            <input type="text" id="ferito_<?php echo $i; ?>_cognome" name="ferito_<?php echo $i; ?>_cognome" value="<?php echo esc_attr(get_post_meta($post->ID, 'ferito_' . $i . '_cognome', true)); ?>" class="regular-text" maxlength="30">
                        </td>
                    </tr>
                    <tr>
                        <th><label for="ferito_<?php echo $i; ?>_istituto">
                                <?php _e('Istituto di cura', 'incidenti-stradali'); ?></label></th>
                        <td>
                            <input type="text" id="ferito_<?php echo $i; ?>_istituto" name="ferito_<?php echo $i; ?>_istituto" value="<?php echo esc_attr(get_post_meta($post->ID, 'ferito_' . $i . '_istituto', true)); ?>" class="regular-text" maxlength="30">
                            <p class="description">
                                <?php _e('Ospedale o struttura sanitaria dove è stato ricoverato', 'incidenti-stradali'); ?>
                            </p>
                        </td>
                    </tr>
                </table>
    ...
    <div class="incidenti-disclaimer-container" style="background: #fff3cd; border: 1px solid #ffeaa7; padding: 15px; margin-bottom: 20px; border-radius: 4px;">
        <h4 style="color: #856404; margin-top: 0;">
            <?php _e('SEGRETO STATISTICO, OBBLIGO DI RISPOSTA, TUTELA DELLA RISERVATEZZA E DIRITTI DEGLI INTERESSATI', 'incidenti-stradali'); ?>
        </h4>
        <div style="font-size: 12px; color: #856404; line-height: 1.4;">
            <p><strong>
                    <?php _e('Decreto legislativo 6 settembre 1989, n. 322', 'incidenti-stradali'); ?></strong> -
                <?php _e('Norme sul Sistema statistico nazionale e sulla riorganizzazione dell\'Istituto nazionale di statistica', 'incidenti-stradali'); ?>
            </p>
            <p><strong>
                    <?php _e('Decreto legislativo 30 giugno 2003, n. 196', 'incidenti-stradali'); ?></strong> -
                <?php _e('Codice in materia di protezione dei dati personali', 'incidenti-stradali'); ?>
            </p>
            <p><strong>
                    <?php _e('Regolamento UE 2016/679', 'incidenti-stradali'); ?></strong> -
                <?php _e('Regolamento generale sulla protezione dei dati', 'incidenti-stradali'); ?>
            </p>
            <p>
                <?php _e('I dati raccolti sono tutelati dal segreto statistico e sottoposti alla normativa in materia di protezione dei dati personali e potranno essere utilizzati, anche per successivi trattamenti, esclusivamente per fini statistici dai soggetti del Sistema statistico nazionale ed essere comunicati per finalità di ricerca scientifica alle condizioni e secondo le modalità previste dall\'art 7 del Codice di deontologia e di buona condotta per i trattamenti di dati personali a scopi statistici.', 'incidenti-stradali'); ?>
            </p>
            <p>
                <?php _e('Titolare del trattamento dei dati è l\'ISTAT – Istituto nazionale di statistica - Via Cesare Balbo, 16 – 00184 Roma. Responsabili del trattamento dei dati sono, per le fasi di rispettiva competenza, il Direttore centrale per le statistiche e le indagini sulle istituzioni sociali dell\'Istat e il preposto all\'Ufficio di statistica della Regione o Provincia autonoma.', 'incidenti-stradali'); ?>
            </p>
            <p>
                <?php _e('L\'inserimento dei nominativi è OBBLIGATORIO ai sensi dell\'art. 7 del d.lgs. n. 322/1989 e fatto obbligo alle amministrazioni, enti ed organismi pubblici, di fornire tutti i dati e le notizie richieste nel modello di rilevazione.', 'incidenti-stradali'); ?>
            </p>
        </div>
    </div>
    ...
    public function render_operazioni_meta_box($post) {
        ?>
        <div class="incidenti-operazioni-container">
            <p style="margin-bottom: 15px;">
                <button type="button" id="stampa-modulo-btn" class="button button-secondary" style="width: 100%; padding: 8px;">
                    📄 <?php _e('Stampa Modulo PDF', 'incidenti-stradali'); ?>
                </button>
            </p>
            <p style="margin-bottom: 15px;">
                <button type="button" id="duplica-incidente-btn" class="button button-secondary" style="width: 100%; padding: 8px;">
                    📋 <?php _e('Duplica Incidente', 'incidenti-stradali'); ?>
                </button>
            </p>
        </div>
        ...
        <script type="text/javascript">
        jQuery(document).ready(function($) {
            $('#stampa-modulo-btn').click(function() {
                if ($(this).hasClass('disabled')) return;
                
                var postId = <?php echo $post->ID; ?>;
                var nonce = '<?php echo wp_create_nonce('stampa_modulo_' . $post->ID); ?>';
                ...
                setTimeout(() => {
                    $(this).removeClass('disabled').html('📄 <?php _e('Stampa Modulo PDF', 'incidenti-stradali'); ?>');
                }, 2000);
            });
        });
        </script>
    ...
    <div id="riepilogo-automatico-container" style="background: #e7f3ff; border: 1px solid #2271b1; padding: 15px; margin: 10px 0; border-radius: 4px;">
        <h4 style="margin-top: 0; color: #2271b1;">📊
            <?php _e('Riepilogo Automatico Infortunati', 'incidenti-stradali'); ?>
        </h4>
        ...
        <div id="conteggio-automatico" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin: 15px 0;">
            <div style="text-align: center; padding: 10px; background: white; border-radius: 4px; border: 1px solid #ddd;">
                ...
                <span style="font-size: 12px; color: #666;">
                    <?php _e('Morti entro 24h', 'incidenti-stradali'); ?></span>
            </div>
            <div style="text-align: center; padding: 10px; background: white; border-radius: 4px; border: 1px solid #ddd;">
                <strong style="display: block; color: #d63638; font-size: 24px;" id="count-morti-2-30gg">0</strong>
                <span style="font-size: 12px; color: #666;">
                    <?php _e('Morti 2°-30° giorno', 'incidenti-stradali'); ?></span>
            </div>
            <div style="text-align: center; padding: 10px; background: white; border-radius: 4px; border: 1px solid #ddd;">
                <strong style="display: block; color: #f0b849; font-size: 24px;" id="count-feriti">0</strong>
                <span style="font-size: 12px; color: #666;">
                    <?php _e('Feriti', 'incidenti-stradali'); ?></span>
            </div>
        </div>
        <div id="riepilogo-dettagli" style="font-size: 12px; color: #666; margin-top: 10px;">
            <p style="margin: 2px 0;"><strong>
                    <?php _e('Calcolo automatico basato su:', 'incidenti-stradali'); ?></strong></p>
            <ul style="margin: 5px 0 0 20px; font-size: 11px;">
                <li>
                    <?php _e('Esiti dei conducenti dei veicoli', 'incidenti-stradali'); ?>
                </li>
                <li>
                    <?php _e('Esiti dei trasportati', 'incidenti-stradali'); ?>
                </li>
                <li>
                    <?php _e('Pedoni morti e feriti', 'incidenti-stradali'); ?>
                </li>
                <li>
                    <?php _e('Altri passeggeri infortunati', 'incidenti-stradali'); ?>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="incidenti-dati-csv-container">
        <table class="form-table">
            <!-- Tipo Strada -->
            <tr>
                <th><label for="csv_tipo_strada">
                        <?php _e('Tipo Strada', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_tipo_strada" name="csv_tipo_strada">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="1" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '1'); ?>>
                            <?php _e('Fuoriuscita/Sbandamento', 'incidenti-stradali'); ?>
                        </option>
                        <option value="2" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '2'); ?>>
                            <?php _e('Investimento animale', 'incidenti-stradali'); ?>
                        </option>
                        <option value="3" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '3'); ?>>
                            <?php _e('Investimento pedone', 'incidenti-stradali'); ?>
                        </option>
                        <option value="4" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '4'); ?>>
                            <?php _e('Scontro frontale', 'incidenti-stradali'); ?>
                        </option>
                        <option value="5" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '5'); ?>>
                            <?php _e('Scontro laterale', 'incidenti-stradali'); ?>
                        </option>
                        <option value="6" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '6'); ?>>
                            <?php _e('Tamponamento', 'incidenti-stradali'); ?>
                        </option>
                        <option value="7" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '7'); ?>>
                            <?php _e('Urto con ostacolo fisso', 'incidenti-stradali'); ?>
                        </option>
                        <option value="8" <?php selected(get_post_meta($post->ID, 'csv_tipo_strada', true), '8'); ?>>
                            <?php _e('Altro', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            </tr>
            <!-- Centro Abitato -->
            <tr>
                <th><label for="csv_centro_abitato">
                        <?php _e('Centro Abitato', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_centro_abitato" name="csv_centro_abitato">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="S" <?php selected(get_post_meta($post->ID, 'csv_centro_abitato', true), 'S'); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?>
                        </option>
                        <option value="N" <?php selected(get_post_meta($post->ID, 'csv_centro_abitato', true), 'N'); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            </tr>
            <!-- Caratteristiche -->
            <tr>
                <th><label for="csv_caratteristiche">
                        <?php _e('Caratteristiche', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_caratteristiche" name="csv_caratteristiche">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="1" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '1'); ?>>
                            <?php _e('Non specificato', 'incidenti-stradali'); ?>
                        </option>
                        <option value="2" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '2'); ?>>
                            <?php _e('Incrocio', 'incidenti-stradali'); ?>
                        </option>
                        <option value="3" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '3'); ?>>
                            <?php _e('Rotatoria', 'incidenti-stradali'); ?>
                        </option>
                        <option value="4" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '4'); ?>>
                            <?php _e('Intersezione segnalata', 'incidenti-stradali'); ?>
                        </option>
                        <option value="5" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '5'); ?>>
                            <?php _e('Intersezione con semaforo o vigile', 'incidenti-stradali'); ?>
                        </option>
                        <option value="6" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '6'); ?>>
                            <?php _e('Intersezione non segnalata', 'incidenti-stradali'); ?>
                        </option>
                        <option value="7" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '7'); ?>>
                            <?php _e('Passaggio a livello', 'incidenti-stradali'); ?>
                        </option>
                        <option value="8" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '8'); ?>>
                            <?php _e('Rettilineo', 'incidenti-stradali'); ?>
                        </option>
                        <option value="9" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '9'); ?>>
                            <?php _e('Curva', 'incidenti-stradali'); ?>
                        </option>
                        <option value="10" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '10'); ?>>
                            <?php _e('Raccordo convesso (dosso)', 'incidenti-stradali'); ?>
                        </option>
                        <option value="11" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '11'); ?>>
                            <?php _e('Pendenza pericolosa', 'incidenti-stradali'); ?>
                        </option>
                        <option value="12" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '12'); ?>>
                            <?php _e('Galleria illuminata', 'incidenti-stradali'); ?>
                        </option>
                        <option value="13" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '13'); ?>>
                            <?php _e('Galleria non illuminata', 'incidenti-stradali'); ?>
                        </option>
                        <option value="14" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '14'); ?>>
                            <?php _e('Intersezione con semaf. giallo. lampegg.', 'incidenti-stradali'); ?>
                        </option>
                        <option value="15" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '15'); ?>>
                            <?php _e('Passaggio a livello custodito', 'incidenti-stradali'); ?>
                        </option>
                        <option value="16" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '16'); ?>>
                            <?php _e('Passaggio a livello non custodito', 'incidenti-stradali'); ?>
                        </option>
                        <option value="17" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '17'); ?>>
                            <?php _e('Raccordo concavo (cunetta)', 'incidenti-stradali'); ?>
                        </option>
                        <option value="18" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '18'); ?>>
                            <?php _e('Strettoia', 'incidenti-stradali'); ?>
                        </option>
                        <option value="19" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '19'); ?>>
                            <?php _e('Pianeggiante', 'incidenti-stradali'); ?>
                        </option>
                        <option value="20" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '20'); ?>>
                            <?php _e('Curva a destra', 'incidenti-stradali'); ?>
                        </option>
                        <option value="21" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '21'); ?>>
                            <?php _e('Curva a sinistra', 'incidenti-stradali'); ?>
                        </option>
                        <option value="22" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '22'); ?>>
                            <?php _e('Salita', 'incidenti-stradali'); ?>
                        </option>
                        <option value="23" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '23'); ?>>
                            <?php _e('Discesa', 'incidenti-stradali'); ?>
                        </option>
                        <option value="24" <?php selected(get_post_meta($post->ID, 'csv_caratteristiche', true), '24'); ?>>
                            <?php _e('Viadotto', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            </tr>
            <!-- Cantiere Stradale -->
            <tr>
                <th><label for="csv_cantiere_stradale">
                        <?php _e('Cantiere Stradale', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_cantiere_stradale" name="csv_cantiere_stradale">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="S" <?php selected(get_post_meta($post->ID, 'csv_cantiere_stradale', true), 'S'); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?>
                        </option>
                        <option value="N" <?php selected(get_post_meta($post->ID, 'csv_cantiere_stradale', true), 'N'); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            ...
            <tr>
                <th colspan="2">
                    <h4>
                        <?php _e('Numero Veicoli Coinvolti', 'incidenti-stradali'); ?>
                    </h4>
                </th>
            </tr>
            <tr>
                <th><label for="csv_n_autovettura">
                        <?php _e('N.Autovettura', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_autocarro_35t">
                        <?php _e('N.Autocarro fino 3,5t', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_autocarro_oltre_35t">
                        <?php _e('N_Autocarro > 3,5t', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_autotreno">
                        <?php _e('N_Autotreno', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_autoarticolato">
                        <?php _e('N_Autoarticolato', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_autobus">
                        <?php _e('N_Autobus', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_tram">
                        <?php _e('N_Tram', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_treno">
                        <?php _e('N_Treno', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_motociclo">
                        <?php _e('N_Motociclo', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_ciclomotore">
                        <?php _e('N_Ciclomotore', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_velocipede">
                        <?php _e('N_Velocipede', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_bicicletta_assistita">
                        <?php _e('N_Bicicletta a pedali assistita', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_monopattini">
                        <?php _e('N_Monopattini elettrici', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_altri_micromobilita">
                        <?php _e('N_Altri dispositivi micromobilità', 'incidenti-stradali'); ?></label></th>
            ...
            <tr>
                <th><label for="csv_n_altri_veicoli">
                        <?php _e('N_Altri Veicoli', 'incidenti-stradali'); ?></label></th>
            ...
            <!-- Altri campi -->
            <tr>
                <th><label for="csv_trasportanti_merci_pericolose">
                        <?php _e('Trasportanti merci pericolose', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_trasportanti_merci_pericolose" name="csv_trasportanti_merci_pericolose">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="S" <?php selected(get_post_meta($post->ID, 'csv_trasportanti_merci_pericolose', true), 'S'); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?>
                        </option>
                        <option value="N" <?php selected(get_post_meta($post->ID, 'csv_trasportanti_merci_pericolose', true), 'N'); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            ...
            <tr>
                <th><label for="csv_omissione">
                        <?php _e('Omissione', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_omissione" name="csv_omissione">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="S" <?php selected(get_post_meta($post->ID, 'csv_omissione', true), 'S'); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?>
                        </option>
                        <option value="N" <?php selected(get_post_meta($post->ID, 'csv_omissione', true), 'N'); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            ...
            <tr>
                <th><label for="csv_contromano">
                        <?php _e('Contromano', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_contromano" name="csv_contromano">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="S" <?php selected(get_post_meta($post->ID, 'csv_contromano', true), 'S'); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?>
                        </option>
                        <option value="N" <?php selected(get_post_meta($post->ID, 'csv_contromano', true), 'N'); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            ...
            <tr>
                <th><label for="csv_dettaglio_persone_decedute">
                        <?php _e('Dettaglio Persone Decedute', 'incidenti-stradali'); ?></label></th>
                <td>
                    ...
                    <p class="description">
                        <?php _e('Formato: tipo_veicolo_ruolo_età_sesso. Separare dati con "_" e persone con ";"<br>Esempio: Motociclo_Conducente_15_M;Pedone_Pedone_25_F;', 'incidenti-stradali'); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th><label for="csv_positivita">
                        <?php _e('Positività', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="csv_positivita" name="csv_positivita">
                        <option value="">
                            <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Entrambi" <?php selected(get_post_meta($post->ID, 'csv_positivita', true), 'Entrambi'); ?>>
                            <?php _e('Entrambi', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Alcol" <?php selected(get_post_meta($post->ID, 'csv_positivita', true), 'Alcol'); ?>>
                            <?php _e('Alcol', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Droga" <?php selected(get_post_meta($post->ID, 'csv_positivita', true), 'Droga'); ?>>
                            <?php _e('Droga', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Negativo" <?php selected(get_post_meta($post->ID, 'csv_positivita', true), 'Negativo'); ?>>
                            <?php _e('Negativo', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                    <p class="description">
                        <?php _e('"Entrambi": uno o più conducenti positivi ad alcol e droga; "Alcol": solo ad alcol; "Droga": solo a droga; "Negativo": nessun conducente positivo', 'incidenti-stradali'); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th><label for="csv_art_cds">
                        <?php _e('Art Cds', 'incidenti-stradali'); ?></label></th>
                <td>
                    ...
                    <p class="description">
                        <?php _e('Formato: articolo/comma. Separare violazioni con ";"<br>Esempio: 189/9;186/3', 'incidenti-stradali'); ?>
                    </p>
                </td>
            </tr>
        </table>
    ...
    <table class="form-table">
        <tr>
            <th><label for="altri_morti_maschi">
                    <?php _e('Altri morti maschi', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="number" id="altri_morti_maschi" name="altri_morti_maschi" value="<?php echo esc_attr(get_post_meta($post->ID, 'altri_morti_maschi', true)); ?>" min="0" max="99">
                <p class="description">
                    <?php _e('Morti oltre ai 3 conducenti e 4 pedoni già inseriti', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="altri_morti_femmine">
                    <?php _e('Altri morti femmine', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="number" id="altri_morti_femmine" name="altri_morti_femmine" value="<?php echo esc_attr(get_post_meta($post->ID, 'altri_morti_femmine', true)); ?>" min="0" max="99">
            </td>
        </tr>
        <tr>
            <th><label for="altri_feriti_maschi">
                    <?php _e('Altri feriti maschi', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="number" id="altri_feriti_maschi" name="altri_feriti_maschi" value="<?php echo esc_attr(get_post_meta($post->ID, 'altri_feriti_maschi', true)); ?>" min="0" max="99">
                <p class="description">
                    <?php _e('Feriti oltre ai 3 conducenti e 4 pedoni già inseriti', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="altri_feriti_femmine">
                    <?php _e('Altri feriti femmine', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="number" id="altri_feriti_femmine" name="altri_feriti_femmine" value="<?php echo esc_attr(get_post_meta($post->ID, 'altri_feriti_femmine', true)); ?>" min="0" max="99">
            </td>
        </tr>
        <tr>
            <th><label for="numero_altri_veicoli">
                    <?php _e('Numero altri veicoli coinvolti', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="number" id="numero_altri_veicoli" name="numero_altri_veicoli" value="<?php echo esc_attr(get_post_meta($post->ID, 'numero_altri_veicoli', true)); ?>" min="0" max="99">
                <p class="description">
                    <?php _e('Veicoli coinvolti oltre ai 3 già inseriti', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="localizzazione_extra_ab">
                    <?php _e('Localizzazione extraurbana', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="localizzazione_extra_ab" name="localizzazione_extra_ab">
                    <option value="">
                        <?php _e('Seleziona', 'incidenti-stradali'); ?>
                    </option>
                    <option value="Su strada statale fuori dall'autostrada" <?php selected(get_post_meta($post->ID, 'localizzazione_extra_ab', true), 'Su strada statale fuori dall\'autostrada'); ?>>
                        <?php _e('Su strada statale fuori dall\'autostrada', 'incidenti-stradali'); ?>
                    </option>
                    <option value="Su autostrada" <?php selected(get_post_meta($post->ID, 'localizzazione_extra_ab', true), 'Su autostrada'); ?>>
                        <?php _e('Su autostrada', 'incidenti-stradali'); ?>
                    </option>
                    <option value="Su raccordo autostradale" <?php selected(get_post_meta($post->ID, 'localizzazione_extra_ab', true), 'Su raccordo autostradale'); ?>>
                        <?php _e('Su raccordo autostradale', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
    ...
    <table class="form-table">
        <tr>
            <th><label for="data_incidente">
                    <?php _e('Data dell\'Incidente', 'incidenti-stradali'); ?> *</label></th>
            <td>
                <input type="date" id="data_incidente" name="data_incidente" value="<?php echo esc_attr($data_incidente); ?>" required>
            </td>
        </tr>
        <tr>
            <th><label for="ora_incidente">
                    <?php _e('Ora dell\'Incidente', 'incidenti-stradali'); ?> *</label></th>
            <td>
                <select id="ora_incidente" name="ora_incidente" required>
                    <option value="">
                        <?php _e('Seleziona ora', 'incidenti-stradali'); ?>
                    </option>
                    <?php for($i = 0; $i <= 24; $i++): ?>
                ...
                <select id="minuti_incidente" name="minuti_incidente">
                    <option value="">
                        <?php _e('Seleziona minuti', 'incidenti-stradali'); ?>
                    </option>
                    <?php for($m = 0; $m <= 59; $m++): ?>
        ...
        <tr>
            <th><label for="provincia_incidente">
                    <?php _e('Provincia', 'incidenti-stradali'); ?> *</label></th>
            <td>
                ...
                <p class="description">
                    <?php _e('Provincia di Lecce - codice ISTAT 075', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="comune_incidente">
                    <?php _e('Comune', 'incidenti-stradali'); ?> *</label></th>
            <td>
                <?php
                ...
                <select id="comune_incidente" name="comune_incidente" required class="regular-text">
                    <option value="">
                        <?php _e('Seleziona comune', 'incidenti-stradali'); ?>
                    </option>
                ...
                <p class="description">
                    <?php _e('Comuni disponibili per il tuo ente di appartenenza', 'incidenti-stradali'); ?>
                </p>
                <?php else: ?>
                <select id="comune_incidente" name="comune_incidente" required class="regular-text">
                    <option value="">
                ...
                <p class="description">
                    <?php _e('Seleziona il comune dove è avvenuto l\'incidente', 'incidenti-stradali'); ?>
                </p>
                <?php endif; ?>
            </td>
        </tr>
        <tr>
            <th><label for="localita_incidente">
                    <?php _e('Località', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="localita_incidente" name="localita_incidente" value="<?php echo esc_attr($localita); ?>" class="regular-text">
                <p class="description">
                    <?php _e('Frazione o località specifica (opzionale)', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        ...
        <tr>
            <th><label for="ente_rilevatore">
                    <?php _e('Ente', 'incidenti-stradali'); ?></label></th>
            <td>
                <?php
                ...
                <p class="description">
                    <?php _e('Ente di appartenenza dell\'operatore', 'incidenti-stradali'); ?>
                </p>
                <?php else: ?>
                <select id="ente_rilevatore" name="ente_rilevatore" class="regular-text">
                    <option value="">
                        <?php _e('Seleziona ente', 'incidenti-stradali'); ?>
                    </option>
                    ...
                    <optgroup label="<?php _e('Altri Enti', 'incidenti-stradali'); ?>">
                        <option value="Carabiniere" <?php selected($ente_rilevatore, 'Carabiniere' ); ?>>
                            <?php _e('Carabiniere', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Agente di Polizia Stradale" <?php selected($ente_rilevatore, 'Agente di Polizia Stradale' ); ?>>
                            <?php _e('Agente di Polizia Stradale', 'incidenti-stradali'); ?>
                        </option>
                        <option value="Polizia Provinciale" <?php selected($ente_rilevatore, 'Polizia Provinciale' ); ?>>
                            <?php _e('Polizia Provinciale', 'incidenti-stradali'); ?>
                        </option>
                    </optgroup>
                </select>
                <p class="description">
                    <?php _e('Seleziona l\'ente che ha rilevato l\'incidente', 'incidenti-stradali'); ?>
                </p>
                <?php endif; ?>
            </td>
        </tr>
        <tr id="identificativo_comando_row" style="display: none;">
            <th><label for="identificativo_comando">
                    <?php _e('Identificativo del Comando Staz. dei Carabinieri', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="identificativo_comando" name="identificativo_comando" value="<?php echo esc_attr(get_post_meta($post->ID, 'identificativo_comando', true)); ?>" maxlength="20" class="regular-text">
                <p class="description">
                    <?php _e('Obbligatorio solo per organo Carabiniere', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="nome_rilevatore">
                    <?php _e('Rilevatore', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="nome_rilevatore" name="nome_rilevatore" value="<?php echo esc_attr($nome_rilevatore); ?>" class="regular-text">
                <p class="description">
                    <?php _e('Nome e cognome del rilevatore', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr style="display: none;">
            <th><label for="codice__ente">
                    <?php _e('Codice Ente (Auto-generato)', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr style="display: none;">
            <th><label for="organo_rilevazione">
                    <?php _e('Organo di Rilevazione (ISTAT)', 'incidenti-stradali'); ?></label></th>
            <td>
                <?php
                ...
                <select id="organo_rilevazione" name="organo_rilevazione">
                    <option value="">
                        <?php _e('Seleziona organo', 'incidenti-stradali'); ?>
                    </option>
                    <option value="1" <?php selected($organo_rilevazione, '1' ); ?>>
                        <?php _e('Agente di Polizia Stradale', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($organo_rilevazione, '2' ); ?>>
                        <?php _e('Carabiniere', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($organo_rilevazione, '3' ); ?>>
                        <?php _e('Agente di Pubblica Sicurezza', 'incidenti-stradali'); ?>
                    </option>
                    <option value="4" <?php selected($organo_rilevazione, '4' ); ?>>
                        <?php _e('Agente di Polizia Municipale o Locale', 'incidenti-stradali'); ?>
                    </option>
                    <option value="5" <?php selected($organo_rilevazione, '5' ); ?>>
                        <?php _e('Altri', 'incidenti-stradali'); ?>
                    </option>
                    <option value="6" <?php selected($organo_rilevazione, '6' ); ?>>
                        <?php _e('Agente di Polizia Provinciale', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
        <tr>
            <th><label for="organo_coordinatore">
                    <?php _e('Organo Coordinatore (ISTAT)', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="organo_coordinatore" name="organo_coordinatore">
                    <option value="">
                        <?php _e('Seleziona organo coordinatore', 'incidenti-stradali'); ?>
                    </option>
                    <option value="1" <?php selected($organo_coordinatore, '1' ); ?>>
                        <?php _e('Sezione di Polizia Stradale', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($organo_coordinatore, '2' ); ?>>
                        <?php _e('Gruppo Carabinieri', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($organo_coordinatore, '3' ); ?>>
                        <?php _e('Ufficio comunale di statistica: Comune con oltre 250.000 abitanti', 'incidenti-stradali'); ?>
                    </option>
                    <option value="4" <?php selected($organo_coordinatore, '4' ); ?>>
                        <?php _e('Altro capoluogo di provincia', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
    ...
    <table class="form-table">
        <tr>
            <th><label for="tipo_strada">
                    <?php _e('Tipo di Strada', 'incidenti-stradali'); ?> *</label></th>
            <td>
                <select id="tipo_strada" name="tipo_strada" required>
                    <option value="">
                        <?php _e('Seleziona tipo strada', 'incidenti-stradali'); ?>
                    </option>
                    <optgroup label="<?php _e('Nell\'abitato', 'incidenti-stradali'); ?>">
                        <option value="1" <?php selected($tipo_strada, '1' ); ?>>
                            <?php _e('Strada urbana', 'incidenti-stradali'); ?>
                        </option>
                        <option value="2" <?php selected($tipo_strada, '2' ); ?>>
                            <?php _e('Provinciale entro l\'abitato', 'incidenti-stradali'); ?>
                        </option>
                        <option value="3" <?php selected($tipo_strada, '3' ); ?>>
                            <?php _e('Statale entro l\'abitato', 'incidenti-stradali'); ?>
                        </option>
                        <option value="0" <?php selected($tipo_strada, '0' ); ?>>
                            <?php _e('Regionale entro l\'abitato', 'incidenti-stradali'); ?>
                        </option>
                    </optgroup>
                    <optgroup label="<?php _e('Fuori dall\'abitato', 'incidenti-stradali'); ?>">
                        <option value="4" <?php selected($tipo_strada, '4' ); ?>>
                            <?php _e('Strada comunale extraurbana', 'incidenti-stradali'); ?>
                        </option>
                        <option value="5" <?php selected($tipo_strada, '5' ); ?>>
                            <?php _e('Strada provinciale fuori dell\'abitato', 'incidenti-stradali'); ?>
                        </option>
                        <option value="6" <?php selected($tipo_strada, '6' ); ?>>
                            <?php _e('Strada statale fuori dell\'abitato', 'incidenti-stradali'); ?>
                        </option>
                        <option value="7" <?php selected($tipo_strada, '7' ); ?>>
                            <?php _e('Autostrada', 'incidenti-stradali'); ?>
                        </option>
                        <option value="8" <?php selected($tipo_strada, '8' ); ?>>
                            <?php _e('Altra strada', 'incidenti-stradali'); ?>
                        </option>
                        <option value="9" <?php selected($tipo_strada, '9' ); ?>>
                            <?php _e('Strada regionale fuori l\'abitato', 'incidenti-stradali'); ?>
                        </option>
                    </optgroup>
                </select>
            </td>
        ...
        <tr>
            <th><label for="denominazione_strada">
                    <?php _e('Denominazione della Strada', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="tronco_strada">
                    <?php _e('Tronco di strada o autostrada', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="tronco_strada" name="tronco_strada">
                    <option value="">
                        <?php _e('Seleziona...', 'incidenti-stradali'); ?>
                    </option>
                    <option value="1" <?php selected($tronco_strada, '1' ); ?>>
                        <?php _e('diramazione; dir. A', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($tronco_strada, '2' ); ?>>
                        <?php _e('dir. B; radd.', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($tronco_strada, '3' ); ?>>
                        <?php _e('bis; dir. C', 'incidenti-stradali'); ?>
                    </option>
                    <option value="4" <?php selected($tronco_strada, '4' ); ?>>
                        <?php _e('ter; bis dir.', 'incidenti-stradali'); ?>
                    </option>
                    <option value="5" <?php selected($tronco_strada, '5' ); ?>>
                        <?php _e('quater; racc.; bis racc.', 'incidenti-stradali'); ?>
                    </option>
                    <option value="6" <?php selected($tronco_strada, '6' ); ?>>
                        <?php _e('Autostrada carreggiata sinistra', 'incidenti-stradali'); ?>
                    </option>
                    <option value="7" <?php selected($tronco_strada, '7' ); ?>>
                        <?php _e('Autostrada carreggiata destra', 'incidenti-stradali'); ?>
                    </option>
                    <option value="8" <?php selected($tronco_strada, '8' ); ?>>
                        <?php _e('Autostrada svincolo entrata', 'incidenti-stradali'); ?>
                    </option>
                    <option value="9" <?php selected($tronco_strada, '9' ); ?>>
                        <?php _e('Autostrada svincolo uscita', 'incidenti-stradali'); ?>
                    </option>
                    <option value="10" <?php selected($tronco_strada, '10' ); ?>>
                        <?php _e('Autostrada svincolo tronco d.c.', 'incidenti-stradali'); ?>
                    </option>
                    <option value="11" <?php selected($tronco_strada, '11' ); ?>>
                        <?php _e('Autostrada stazione', 'incidenti-stradali'); ?>
                    </option>
                    <option value="12" <?php selected($tronco_strada, '12' ); ?>>
                        <?php _e('Altri casi', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
        <tr id="numero_strada_row">
            <th><label for="numero_strada">
                    <?php _e('Numero Strada', 'incidenti-stradali'); ?></label></th>
            <td>
                ...
                <select id="numero_strada_select" name="numero_strada" class="regular-text" style="display: none;" data-saved-value="<?php echo esc_attr($numero_strada); ?>">
                    <option value="">
                        <?php _e('Seleziona strada provinciale', 'incidenti-stradali'); ?>
                    </option>
                </select>
                <!-- Campo select per strade statali -->
                <select id="numero_strada_select_statali" name="numero_strada" class="regular-text" style="display: none;" data-saved-value="<?php echo esc_attr($numero_strada); ?>">
                    <option value="">
                        <?php _e('Seleziona strada statale', 'incidenti-stradali'); ?>
                    </option>
                </select>
        ...
        <tr id="progressiva_row">
            <th><label>
                    <?php _e('Progressiva Chilometrica', 'incidenti-stradali'); ?></label></th>
            <td>
                <label for="progressiva_km">
                    <?php _e('Km', 'incidenti-stradali'); ?></label>
                ...
                <label for="progressiva_m">
                    <?php _e('Mt', 'incidenti-stradali'); ?></label>
                ...
                <p class="description">
                    <?php _e('Specificare km e metri separatamente', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
    </table>
    ...
    <div class="incidenti-mappa-localizzazione">
        <h4>
            <?php _e('Seleziona Posizione sulla Mappa', 'incidenti-stradali'); ?>
        </h4>
        <div class="incidenti-map-info-inline">
            <p class="description">
                <strong>
                    <?php _e('Sistema:', 'incidenti-stradali'); ?></strong> WGS84 (GPS) •
                <strong>
                    <?php _e('Clic sulla mappa', 'incidenti-stradali'); ?></strong> per impostare le coordinate
            </p>
            <div class="coordinate-inputs-inline">
                <label for="latitudine_inline">
                    <?php _e('Latitudine:', 'incidenti-stradali'); ?></label>
                <input type="text" id="latitudine_inline" name="latitudine" value="<?php echo esc_attr(get_post_meta($post->ID, 'latitudine', true)); ?>" placeholder="es. 41.902783" class="incidenti-coordinate-input-inline">
                <label for="longitudine_inline">
                    <?php _e('Longitudine:', 'incidenti-stradali'); ?></label>
                <input type="text" id="longitudine_inline" name="longitudine" value="<?php echo esc_attr(get_post_meta($post->ID, 'longitudine', true)); ?>" placeholder="es. 12.496366" class="incidenti-coordinate-input-inline">
            </div>
        </div>
    ...
    <div class="luogo-incidente-sections">
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Tipi di Strada', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th><label for="geometria_strada">
                            <?php _e('Configurazione Carreggiate', 'incidenti-stradali'); ?></label></th>
                    <td>
                        <label><input type="radio" name="geometria_strada" value="1" <?php checked($geometria_strada, '1' ); ?>>
                            <?php _e('Una carreggiata senso unico', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="geometria_strada" value="2" <?php checked($geometria_strada, '2' ); ?>>
                            <?php _e('Una carreggiata doppio senso', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="geometria_strada" value="3" <?php checked($geometria_strada, '3' ); ?>>
                            <?php _e('Due carreggiate', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="geometria_strada" value="4" <?php checked($geometria_strada, '4' ); ?>>
                            <?php _e('Più di 2 carreggiate', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Pavimentazione', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Tipo Pavimentazione', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="pavimentazione_strada" value="1" <?php checked($pavimentazione, '1' ); ?>>
                            <?php _e('Strada pavimentata', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="pavimentazione_strada" value="2" <?php checked($pavimentazione, '2' ); ?>>
                            <?php _e('Strada pavimentata dissestata', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="pavimentazione_strada" value="3" <?php checked($pavimentazione, '3' ); ?>>
                            <?php _e('Strada non pavimentata', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Condizioni Manto', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="condizioni_manto" value="aperto" <?php checked($condizioni_manto, 'aperto' ); ?>>
                            <?php _e('Tappeto d\'usura aperto', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_manto" value="chiuso" <?php checked($condizioni_manto, 'chiuso' ); ?>>
                            <?php _e('Tappeto d\'usura chiuso', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Intersezione', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Tipo Intersezione', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="intersezione_tronco" value="1" <?php checked($intersezione, '1' ); ?>>
                            <?php _e('Incrocio', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="2" <?php checked($intersezione, '2' ); ?>>
                            <?php _e('Rotatoria', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="3" <?php checked($intersezione, '3' ); ?>>
                            <?php _e('Intersezione segnalata', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="4" <?php checked($intersezione, '4' ); ?>>
                            <?php _e('Intersezione con semaforo o vigile', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="5" <?php checked($intersezione, '5' ); ?>>
                            <?php _e('Intersezione non segnalata', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="6" <?php checked($intersezione, '6' ); ?>>
                            <?php _e('Passaggio a livello', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Non Intersezione', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="intersezione_tronco" value="7" <?php checked($intersezione, '7' ); ?>>
                            <?php _e('Rettilineo', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="8" <?php checked($intersezione, '8' ); ?>>
                            <?php _e('Curva', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="9" <?php checked($intersezione, '9' ); ?>>
                            <?php _e('Dosso, strettoia', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="10" <?php checked($intersezione, '10' ); ?>>
                            <?php _e('Pend. - salita', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="10b" <?php checked($intersezione, '10b' ); ?>>
                            <?php _e('Pend. - discesa', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="11" <?php checked($intersezione, '11' ); ?>>
                            <?php _e('Gall. illuminata', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="12" <?php checked($intersezione, '12' ); ?>>
                            <?php _e('Gall. non illuminata', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Caratteristiche Geometriche', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="intersezione_tronco" value="14" <?php checked($intersezione, '14' ); ?>>
                            <?php _e('Cunetta', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="15" <?php checked($intersezione, '15' ); ?>>
                            <?php _e('Cavalcavia', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="16" <?php checked($intersezione, '16' ); ?>>
                            <?php _e('Trincea', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="17" <?php checked($intersezione, '17' ); ?>>
                            <?php _e('Rilevato', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="intersezione_tronco" value="18" <?php checked($intersezione, '18' ); ?>>
                            <?php _e('Accessi laterali', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Fondo Stradale', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Condizioni Fondo', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="stato_fondo_strada" value="1" <?php checked($fondo_strada, '1' ); ?>>
                            <?php _e('Asciutto', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="stato_fondo_strada" value="2" <?php checked($fondo_strada, '2' ); ?>>
                            <?php _e('Bagnato', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="stato_fondo_strada" value="3" <?php checked($fondo_strada, '3' ); ?>>
                            <?php _e('Sdrucciolevole', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="stato_fondo_strada" value="4" <?php checked($fondo_strada, '4' ); ?>>
                            <?php _e('Ghiacciato', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="stato_fondo_strada" value="5" <?php checked($fondo_strada, '5' ); ?>>
                            <?php _e('Innevato', 'incidenti-stradali'); ?></label><br>
                        <label><input type="checkbox" name="allagato" value="1" <?php checked($allagato, '1' ); ?>>
                            <?php _e('Allagato', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Segnaletica', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Tipo Segnaletica', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="segnaletica_strada" value="1" <?php checked($segnaletica, '1' ); ?>>
                            <?php _e('Assente', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="segnaletica_strada" value="2" <?php checked($segnaletica, '2' ); ?>>
                            <?php _e('Verticale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="segnaletica_strada" value="3" <?php checked($segnaletica, '3' ); ?>>
                            <?php _e('Orizzontale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="segnaletica_strada" value="4" <?php checked($segnaletica, '4' ); ?>>
                            <?php _e('Verticale e orizzontale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="segnaletica_strada" value="5" <?php checked($segnaletica, '5' ); ?>>
                            <?php _e('Temporanea di cantiere', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Elementi Aggiuntivi', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="checkbox" name="semaforizzazioni" value="1" <?php checked($semaforizzazioni, '1' ); ?>>
                            <?php _e('Semaforizzazioni', 'incidenti-stradali'); ?></label><br>
                        <label><input type="checkbox" name="cartelli_pubblicitari" value="1" <?php checked($cartelli_pubblicitari, '1' ); ?>>
                            <?php _e('Cartelli pubblicitari', 'incidenti-stradali'); ?></label><br>
                        <label><input type="checkbox" name="leggibilita_alta" value="1" <?php checked($leggibilita_alta, '1' ); ?>>
                            <?php _e('Leggibilità alta', 'incidenti-stradali'); ?></label><br>
                        <label><input type="checkbox" name="leggibilita_bassa" value="1" <?php checked($leggibilita_bassa, '1' ); ?>>
                            <?php _e('Leggibilità bassa', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Condizioni Meteorologiche', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Condizioni Meteo', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="condizioni_meteo" value="1" <?php checked($condizioni_meteo, '1' ); ?>>
                            <?php _e('Sereno', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="2" <?php checked($condizioni_meteo, '2' ); ?>>
                            <?php _e('Nebbia', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="3" <?php checked($condizioni_meteo, '3' ); ?>>
                            <?php _e('Pioggia', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="4" <?php checked($condizioni_meteo, '4' ); ?>>
                            <?php _e('Grandine', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="5" <?php checked($condizioni_meteo, '5' ); ?>>
                            <?php _e('Neve', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="6" <?php checked($condizioni_meteo, '6' ); ?>>
                            <?php _e('Vento forte', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="condizioni_meteo" value="7" <?php checked($condizioni_meteo, '7' ); ?>>
                            <?php _e('Altro', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Condizioni Aggiuntive', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="checkbox" name="nuvoloso" value="1" <?php checked($nuvoloso, '1' ); ?>>
                            <?php _e('Nuvoloso', 'incidenti-stradali'); ?></label><br>
                        <label><input type="checkbox" name="foschia" value="1" <?php checked($foschia, '1' ); ?>>
                            <?php _e('Foschia', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="sezione-luogo">
            <h4>
                <?php _e('Illuminazione', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Condizioni di illuminazione', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="illuminazione" value="1" <?php checked($illuminazione, '1' ); ?>>
                            <?php _e('Luce diurna', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="illuminazione" value="2" <?php checked($illuminazione, '2' ); ?>>
                            <?php _e('Crepuscolo alba', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="illuminazione" value="3" <?php checked($illuminazione, '3' ); ?>>
                            <?php _e('Buio: luci stradali presenti accese', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="illuminazione" value="4" <?php checked($illuminazione, '4' ); ?>>
                            <?php _e('Buio: luci stradali presenti spente', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="illuminazione" value="5" <?php checked($illuminazione, '5' ); ?>>
                            <?php _e('Buio: assenza di illuminazione stradale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="illuminazione" value="6" <?php checked($illuminazione, '6' ); ?>>
                            <?php _e('Illuminazione stradale non nota', 'incidenti-stradali'); ?></label><br>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="sezione-luogo">
            <h4>
                <?php _e('Altre Caratteristiche', 'incidenti-stradali'); ?>
            </h4>
            <table class="form-table">
                <tr>
                    <th>
                        <?php _e('Orientamento del conducente', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="orientamento_conducente" value="sole_frontale" <?php checked($orientamento_conducente, 'sole_frontale' ); ?>>
                            <?php _e('Sole frontale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="orientamento_conducente" value="sole_laterale" <?php checked($orientamento_conducente, 'sole_laterale' ); ?>>
                            <?php _e('Sole laterale', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="orientamento_conducente" value="sole_dietro" <?php checked($orientamento_conducente, 'sole_dietro' ); ?>>
                            <?php _e('Sole da dietro', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="orientamento_conducente" value="non_rilevabile" <?php checked($orientamento_conducente, 'non_rilevabile' ); ?>>
                            <?php _e('Non rilevabile', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Presenza banchina', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="checkbox" name="presenza_banchina" value="1" <?php checked($presenza_banchina, '1' ); ?>>
                            <?php _e('Presente', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
                <tr>
                    <th>
                        <?php _e('Presenza barriere', 'incidenti-stradali'); ?>
                    </th>
                    <td>
                        <label><input type="radio" name="presenza_barriere" value="si" <?php checked($presenza_barriere, 'si' ); ?>>
                            <?php _e('Sì', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="presenza_barriere" value="no" <?php checked($presenza_barriere, 'no' ); ?>>
                            <?php _e('No', 'incidenti-stradali'); ?></label><br>
                        <label><input type="radio" name="presenza_barriere" value="danneggiate" <?php checked($presenza_barriere, 'danneggiate' ); ?>>
                            <?php _e('Danneggiate', 'incidenti-stradali'); ?></label>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <table class="form-table">
        <tr>
            <th><label for="natura_incidente">
                    <?php _e('Natura dell\'Incidente', 'incidenti-stradali'); ?> *</label></th>
            <td>
                <select id="natura_incidente" name="natura_incidente" required>
                    <option value="">
                        <?php _e('Seleziona natura', 'incidenti-stradali'); ?>
                    </option>
                    <option value="A" <?php selected($natura_incidente, 'A' ); ?>>
                        <?php _e('Tra veicoli in marcia', 'incidenti-stradali'); ?>
                    </option>
                    <option value="B" <?php selected($natura_incidente, 'B' ); ?>>
                        <?php _e('Tra veicolo e pedoni', 'incidenti-stradali'); ?>
                    </option>
                    <option value="C" <?php selected($natura_incidente, 'C' ); ?>>
                        <?php _e('Veicolo in marcia che urta veicolo fermo o altro', 'incidenti-stradali'); ?>
                    </option>
                    <option value="D" <?php selected($natura_incidente, 'D' ); ?>>
                        <?php _e('Veicolo in marcia senza urto', 'incidenti-stradali'); ?>
                    </option>
                    <option value="E" <?php selected($natura_incidente, 'E' ); ?>>
                        <?php _e('Altro', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        ...
        <tr id="dettaglio_natura_row">
            <th><label for="dettaglio_natura">
                    <?php _e('Dettaglio', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="dettaglio_natura" name="dettaglio_natura">
                    <option value="">
                        <?php _e('Seleziona dettaglio', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
        <tr id="altro_natura_row" style="display: none;">
            <th><label for="altro_natura_testo">
                    <?php _e('Specifica Altro', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="altro_natura_testo" name="altro_natura_testo" value="<?php echo esc_attr(get_post_meta($post->ID, 'altro_natura_testo', true)); ?>" class="regular-text" maxlength="100" placeholder="<?php _e('Descrivi la natura dell\'incidente', 'incidenti-stradali'); ?>">
                <p class="description">
                    <?php _e('Descrizione personalizzata della natura dell\'incidente (max 100 caratteri)', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr id="numero_veicoli_row">
            <th><label for="numero_veicoli_coinvolti">
                    <?php _e('Numero Veicoli Coinvolti', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="numero_veicoli_coinvolti" name="numero_veicoli_coinvolti">
                    <option value="">
                        <?php _e('Seleziona numero', 'incidenti-stradali'); ?>
                    </option>
    ...
    <table class="form-table">
        <tr>
            <th><label for="<?php echo $prefix; ?>tipo">
                    <?php _e('Tipo Veicolo', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="<?php echo $prefix; ?>tipo" name="<?php echo $prefix; ?>tipo">
                    <option value="">
                        <?php _e('Seleziona tipo', 'incidenti-stradali'); ?>
                    </option>
                    <option value="1" <?php selected($tipo_veicolo, '1' ); ?>>
                        <?php _e('Autovettura privata', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($tipo_veicolo, '2' ); ?>>
                        <?php _e('Autovettura con rimorchio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($tipo_veicolo, '3' ); ?>>
                        <?php _e('Autovettura pubblica', 'incidenti-stradali'); ?>
                    </option>
                    <option value="4" <?php selected($tipo_veicolo, '4' ); ?>>
                        <?php _e('Autovettura di soccorso o di polizia', 'incidenti-stradali'); ?>
                    </option>
                    <option value="5" <?php selected($tipo_veicolo, '5' ); ?>>
                        <?php _e('Autobus o filobus in servizio urbano', 'incidenti-stradali'); ?>
                    </option>
                    <option value="6" <?php selected($tipo_veicolo, '6' ); ?>>
                        <?php _e('Autobus di linea o non di linea in extraurbana', 'incidenti-stradali'); ?>
                    </option>
                    <option value="7" <?php selected($tipo_veicolo, '7' ); ?>>
                        <?php _e('Tram', 'incidenti-stradali'); ?>
                    </option>
                    <option value="8" <?php selected($tipo_veicolo, '8' ); ?>>
                        <?php _e('Autocarro', 'incidenti-stradali'); ?>
                    </option>
                    <option value="9" <?php selected($tipo_veicolo, '9' ); ?>>
                        <?php _e('Autotreno con rimorchio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="10" <?php selected($tipo_veicolo, '10' ); ?>>
                        <?php _e('Autosnodato o autoarticolato', 'incidenti-stradali'); ?>
                    </option>
                    <option value="11" <?php selected($tipo_veicolo, '11' ); ?>>
                        <?php _e('Veicoli speciali', 'incidenti-stradali'); ?>
                    </option>
                    <option value="12" <?php selected($tipo_veicolo, '12' ); ?>>
                        <?php _e('Trattore stradale o motrice', 'incidenti-stradali'); ?>
                    </option>
                    <option value="13" <?php selected($tipo_veicolo, '13' ); ?>>
                        <?php _e('Macchina agricola', 'incidenti-stradali'); ?>
                    </option>
                    <option value="14" <?php selected($tipo_veicolo, '14' ); ?>>
                        <?php _e('Velocipede', 'incidenti-stradali'); ?>
                    </option>
                    <option value="15" <?php selected($tipo_veicolo, '15' ); ?>>
                        <?php _e('Ciclomotore', 'incidenti-stradali'); ?>
                    </option>
                    <option value="16" <?php selected($tipo_veicolo, '16' ); ?>>
                        <?php _e('Motociclo a solo', 'incidenti-stradali'); ?>
                    </option>
                    <option value="17" <?php selected($tipo_veicolo, '17' ); ?>>
                        <?php _e('Motociclo con passeggero', 'incidenti-stradali'); ?>
                    </option>
                    <option value="18" <?php selected($tipo_veicolo, '18' ); ?>>
                        <?php _e('Motocarro o motofurgone', 'incidenti-stradali'); ?>
                    </option>
                    <option value="19" <?php selected($tipo_veicolo, '19' ); ?>>
                        <?php _e('Veicolo a trazione animale o a braccia', 'incidenti-stradali'); ?>
                    </option>
                    <option value="20" <?php selected($tipo_veicolo, '20' ); ?>>
                        <?php _e('Veicolo ignoto perché datosi alla fuga', 'incidenti-stradali'); ?>
                    </option>
                    <option value="21" <?php selected($tipo_veicolo, '21' ); ?>>
                        <?php _e('Quadriciclo', 'incidenti-stradali'); ?>
                    </option>
                    <option value="22" <?php selected($tipo_veicolo, '22' ); ?>>
                        <?php _e('Monopattino', 'incidenti-stradali'); ?>
                    </option>
                    <option value="23" <?php selected($tipo_veicolo, '23' ); ?>>
                        <?php _e('Bicicletta elettrica', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>targa">
                    <?php _e('Targa', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="<?php echo $prefix; ?>targa" name="<?php echo $prefix; ?>targa" value="<?php echo esc_attr($targa); ?>">
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>sigla_estero">
                    <?php _e('Sigla se veicolo estero', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="<?php echo $prefix; ?>sigla_estero" name="<?php echo $prefix; ?>sigla_estero" value="<?php echo esc_attr($sigla_estero); ?>" maxlength="5" class="regular-text" placeholder="<?php _e('Es: D, F, CH...', 'incidenti-stradali'); ?>">
                <p class="description">
                    <?php _e('Inserire la sigla automobilistica internazionale (solo per veicoli con targa estera)', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>anno_immatricolazione">
                    <?php _e('Anno Prima Immatricolazione', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="<?php echo $prefix; ?>cilindrata">
                    <?php _e('Cilindrata (cc)', 'incidenti-stradali'); ?></label></th>
            <td>
                ...
                <p class="description">
                    <?php _e('Inserire fino a 5 cifre (solo numeri)', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>peso_totale">
                    <?php _e('Peso Totale a Pieno Carico (q)', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="<?php echo $prefix; ?>danni_riportati">
                    <?php _e('Danni Riportati', 'incidenti-stradali'); ?></label></th>
            <td>
                <textarea id="<?php echo $prefix; ?>danni_riportati" name="<?php echo $prefix; ?>danni_riportati" rows="3" cols="50" placeholder="<?php _e('Descrivi i danni riportati dal veicolo', 'incidenti-stradali'); ?>"><?php echo esc_textarea(get_post_meta($post->ID, $prefix . 'danni_riportati', true)); ?></textarea>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>tipo_rimorchio">
                    <?php _e('Tipo Rimorchio', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="<?php echo $prefix; ?>tipo_rimorchio" name="<?php echo $prefix; ?>tipo_rimorchio">
                    <option value="">
                        <?php _e('Nessun rimorchio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="1" <?php selected($tipo_rimorchio, '1' ); ?>>
                        <?php _e('Rimorchio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($tipo_rimorchio, '2' ); ?>>
                        <?php _e('Semirimorchio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($tipo_rimorchio, '3' ); ?>>
                        <?php _e('Carrello appendice', 'incidenti-stradali'); ?>
                    </option>
                </select>
                <p class="description">
                    <?php _e('Solo per veicoli con rimorchio', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
        <tr id="<?php echo $prefix; ?>targa_rimorchio_row" style="display: none;">
            <th><label for="<?php echo $prefix; ?>targa_rimorchio">
                    <?php _e('Targa Rimorchio', 'incidenti-stradali'); ?></label></th>
            <td>
                <input type="text" id="<?php echo $prefix; ?>targa_rimorchio" name="<?php echo $prefix; ?>targa_rimorchio" value="<?php echo esc_attr($targa_rimorchio); ?>" maxlength="10" class="regular-text">
            </td>
        </tr>
    </table>
    <?php
    ...
    <table class="form-table">
        <tr>
            <th><label for="veicolo_<?php echo $veicolo_num; ?>_numero_trasportati">
                    <?php _e('Numero Trasportati', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="veicolo_<?php echo $veicolo_num; ?>_numero_trasportati" name="veicolo_<?php echo $veicolo_num; ?>_numero_trasportati">
                    <?php for ($j = 0; $j <= 4; $j++): ?>
                    <option value="<?php echo $j; ?>" <?php selected($num_trasportati, $j); ?>>
                        <?php echo $j; ?>
                    </option>
                    <?php endfor; ?>
                </select>
    ...
    <div id="trasportati-<?php echo $veicolo_num; ?>-container">
        ...
        <div id="trasportato-<?php echo $veicolo_num; ?>-<?php echo $i; ?>" style="display: <?php echo $display; ?>;">
            <h6>
                <?php printf(__('Trasportato %d', 'incidenti-stradali'), $i); ?>
            </h6>
            <table class="form-table">
                <tr>
                    <th><label>
                            <?php _e('Sesso', 'incidenti-stradali'); ?></label></th>
                    <td>
                        <select name="<?php echo $prefix; ?>sesso">
                            <option value="">
                                <?php _e('Seleziona', 'incidenti-stradali'); ?>
                            </option>
                            <option value="3" <?php selected(get_post_meta($post->ID, $prefix . 'sesso', true), '3'); ?>>
                                <?php _e('Maschio', 'incidenti-stradali'); ?>
                            </option>
                            <option value="4" <?php selected(get_post_meta($post->ID, $prefix . 'sesso', true), '4'); ?>>
                                <?php _e('Femmina', 'incidenti-stradali'); ?>
                            </option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <th><label>
                            <?php _e('Posizione Sedile', 'incidenti-stradali'); ?></label></th>
                    <td>
                        <select name="<?php echo $prefix; ?>sedile" id="<?php echo $prefix; ?>sedile" data-veicolo="<?php echo $veicolo_num; ?>" data-trasportato="<?php echo $i; ?>">
                            <option value="">
                                <?php _e('Seleziona posizione', 'incidenti-stradali'); ?>
                            </option>
                            <option value="anteriore" <?php selected(get_post_meta($post->ID, $prefix . 'sedile', true), 'anteriore'); ?>>
                                <?php _e('Sedile anteriore', 'incidenti-stradali'); ?>
                            </option>
                            <option value="posteriore" <?php selected(get_post_meta($post->ID, $prefix . 'sedile', true), 'posteriore'); ?>>
                                <?php _e('Sedile posteriore', 'incidenti-stradali'); ?>
                            </option>
                        </select>
                    </td>
                </tr>
                <tr id="<?php echo $prefix; ?>dettaglio_sedile_row" style="display: none;">
                    <th><label id="<?php echo $prefix; ?>dettaglio_label">
                            <?php _e('Dettaglio', 'incidenti-stradali'); ?></label></th>
                    <td>
                        <input type="text" name="<?php echo $prefix; ?>dettaglio_sedile" id="<?php echo $prefix; ?>dettaglio_sedile" value="<?php echo esc_attr(get_post_meta($post->ID, $prefix . 'dettaglio_sedile', true)); ?>" placeholder="<?php _e('Specifica la posizione...', 'incidenti-stradali'); ?>" class="regular-text">
                    </td>
                </tr>
                <tr>
                    <th><label>
                            <?php _e('Età', 'incidenti-stradali'); ?></label></th>
                ...
                <tr>
                    <th><label>
                            <?php _e('Esito', 'incidenti-stradali'); ?></label></th>
                    <td>
                        <select name="<?php echo $prefix; ?>esito" id="trasportato_<?php echo $veicolo_num; ?>_<?php echo $i; ?>_esito">
                            <option value="">
                                <?php _e('Seleziona', 'incidenti-stradali'); ?>
                            </option>
                            <option value="1" <?php selected(get_post_meta($post->ID, $prefix . 'esito', true), '1'); ?>>
                                <?php _e('Morto', 'incidenti-stradali'); ?>
                            </option>
                            <option value="2" <?php selected(get_post_meta($post->ID, $prefix . 'esito', true), '2'); ?>>
                                <?php _e('Ferito', 'incidenti-stradali'); ?>
                            </option>
                        </select>
                    </td>
                </tr>
    ...
    <div style="margin: 15px 0;">
        <h6>
            <?php printf(__('Altri Passeggeri Infortunati nel Veicolo %s', 'incidenti-stradali'), chr(64 + $veicolo_num)); ?>
        </h6>
        <table style="border-collapse: collapse; margin-top: 10px; background: #f9f9f9; border: 1px solid #ddd;">
            <thead>
                <tr>
                    ...
                    <th style="border: 1px solid #ddd; padding: 8px; background: #e9e9e9; text-align: center; width: 80px;">
                        <?php _e('Maschi', 'incidenti-stradali'); ?>
                    </th>
                    <th style="border: 1px solid #ddd; padding: 8px; background: #e9e9e9; text-align: center; width: 80px;">
                        <?php _e('Femmine', 'incidenti-stradali'); ?>
                    </th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    ...
                    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                        <input type="text" id="veicolo_<?php echo $veicolo_num; ?>_altri_morti_maschi" name="veicolo_<?php echo $veicolo_num; ?>_altri_morti_maschi" value="<?php echo esc_attr(get_post_meta($post->ID, 'veicolo_' . $veicolo_num . '_altri_morti_maschi', true) ?: ''); ?>" pattern="[0-9]{1,2}" maxlength="2" style="width: 50px; text-align: center; border: 1px solid #ccc;" placeholder="0">
                    </td>
                    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                        <input type="text" id="veicolo_<?php echo $veicolo_num; ?>_altri_morti_femmine" name="veicolo_<?php echo $veicolo_num; ?>_altri_morti_femmine" value="<?php echo esc_attr(get_post_meta($post->ID, 'veicolo_' . $veicolo_num . '_altri_morti_femmine', true) ?: ''); ?>" pattern="[0-9]{1,2}" maxlength="2" style="width: 50px; text-align: center; border: 1px solid #ccc;" placeholder="0">
                    </td>
                </tr>
                <tr>
                    <td style="border: 1px solid #ddd; padding: 8px; font-weight: bold; text-align: right; background: #f5f5f5;">
                    ...
                    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                        <input type="text" id="veicolo_<?php echo $veicolo_num; ?>_altri_feriti_maschi" name="veicolo_<?php echo $veicolo_num; ?>_altri_feriti_maschi" value="<?php echo esc_attr(get_post_meta($post->ID, 'veicolo_' . $veicolo_num . '_altri_feriti_maschi', true) ?: ''); ?>" pattern="[0-9]{1,2}" maxlength="2" style="width: 50px; text-align: center; border: 1px solid #ccc;" placeholder="0">
                    </td>
                    <td style="border: 1px solid #ddd; padding: 8px; text-align: center;">
                        <input type="text" id="veicolo_<?php echo $veicolo_num; ?>_altri_feriti_femmine" name="veicolo_<?php echo $veicolo_num; ?>_altri_feriti_femmine" value="<?php echo esc_attr(get_post_meta($post->ID, 'veicolo_' . $veicolo_num . '_altri_feriti_femmine', true) ?: ''); ?>" pattern="[0-9]{1,2}" maxlength="2" style="width: 50px; text-align: center; border: 1px solid #ccc;" placeholder="0">
                    </td>
                </tr>
            </tbody>
        </table>
    ...
    <table class="form-table">
        <tr>
            <th><label for="<?php echo $prefix; ?>eta">
                    <?php _e('Età', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="<?php echo $prefix; ?>sesso">
                    <?php _e('Sesso', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="<?php echo $prefix; ?>sesso" name="<?php echo $prefix; ?>sesso">
                    ...
                    <option value="1" <?php selected($sesso, '1' ); ?>>
                        <?php _e('Maschio', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($sesso, '2' ); ?>>
                        <?php _e('Femmina', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        ...
        <tr>
            <th><label for="<?php echo $prefix; ?>esito">
                    <?php _e('Esito', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="<?php echo $prefix; ?>esito" name="<?php echo $prefix; ?>esito">
                    ...
                    <option value="1" <?php selected($esito, '1' ); ?>>
                        <?php _e('Incolume', 'incidenti-stradali'); ?>
                    </option>
                    <option value="2" <?php selected($esito, '2' ); ?>>
                        <?php _e('Ferito', 'incidenti-stradali'); ?>
                    </option>
                    <option value="3" <?php selected($esito, '3' ); ?>>
                        <?php _e('Morto entro 24 ore', 'incidenti-stradali'); ?>
                    </option>
                    <option value="4" <?php selected($esito, '4' ); ?>>
                        <?php _e('Morto dal 2° al 30° giorno', 'incidenti-stradali'); ?>
                    </option>
                </select>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>tipo_patente">
                    <?php _e('Tipo Patente', 'incidenti-stradali'); ?></label></th>
            <td>
                <div>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="0" <?php checked(in_array('0', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente ciclomotori', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="1" <?php checked(in_array('1', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente tipo A', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="2" <?php checked(in_array('2', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente tipo B', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="3" <?php checked(in_array('3', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente tipo C', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="4" <?php checked(in_array('4', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente tipo D', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="5" <?php checked(in_array('5', (array)$tipo_patente), true); ?>>
                        <?php _e('Patente tipo E', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="6" <?php checked(in_array('6', (array)$tipo_patente), true); ?>>
                        <?php _e('ABC speciale', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="7" <?php checked(in_array('7', (array)$tipo_patente), true); ?>>
                        <?php _e('Non richiesta', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="8" <?php checked(in_array('8', (array)$tipo_patente), true); ?>>
                        <?php _e('Foglio rosa', 'incidenti-stradali'); ?></label><br>
                    <label><input type="checkbox" name="<?php echo $prefix; ?>tipo_patente[]" value="9" <?php checked(in_array('9', (array)$tipo_patente), true); ?>>
                        <?php _e('Sprovvisto', 'incidenti-stradali'); ?></label>
                </div>
            </td>
        </tr>
        <tr>
            <th><label for="<?php echo $prefix; ?>anno_patente">
                    <?php _e('Anno Rilascio Patente', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th><label for="<?php echo $prefix; ?>nazionalita">
                    <?php _e('Nazionalità', 'incidenti-stradali'); ?></label></th>
            <td>
        ...
        <tr>
            <th>
                <?php _e('Tipologia Incidente Lavorativo', 'incidenti-stradali'); ?>
            </th>
            <td>
                <label><input type="radio" name="<?php echo $prefix; ?>tipologia_incidente" value="1" <?php checked(get_post_meta($post->ID, $prefix . 'tipologia_incidente', true), '1'); ?>>
                ...
                <label><input type="radio" name="<?php echo $prefix; ?>tipologia_incidente" value="2" <?php checked(get_post_meta($post->ID, $prefix . 'tipologia_incidente', true), '2'); ?>>
                    <?php _e('Conducente coinvolto in incidente su strada durante il tragitto casa-lavoro o lavoro-casa', 'incidenti-stradali'); ?>
                </label><br>
                <label><input type="radio" name="<?php echo $prefix; ?>tipologia_incidente" value=" " <?php checked(get_post_meta($post->ID, $prefix . 'tipologia_incidente', true), ' '); ?>>
                    <?php _e('Nessuno dei due', 'incidenti-stradali'); ?>
                </label><br><br>
                <p style="font-weight: bold;">
                    <?php _e('Non indicare le due modalità sopra riportate nel caso si tratti di altro tipo di tragitto e/o di incidente avvenuto al di fuori dell\'attività lavorativa.', 'incidenti-stradali'); ?>
                </p>
            </td>
        </tr>
    </table>
    ...
    <table class="form-table">
        <tr>
            <th><label for="numero_pedoni_feriti">
                    <?php _e('Numero Pedoni Feriti', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="numero_pedoni_feriti" name="numero_pedoni_feriti">
                    <?php for ($i = 0; $i <= 4; $i++): ?>
                    <option value="<?php echo $i; ?>" <?php selected($numero_pedoni_feriti, $i); ?>>
                        <?php echo $i; ?>
                    </option>
                    <?php endfor; ?>
                </select>
        ...
        <tr>
            <th><label for="numero_pedoni_morti">
                    <?php _e('Numero Pedoni Morti', 'incidenti-stradali'); ?></label></th>
            <td>
                <select id="numero_pedoni_morti" name="numero_pedoni_morti">
                    <?php for ($i = 0; $i <= 4; $i++): ?>
                    <option value="<?php echo $i; ?>" <?php selected($numero_pedoni_morti, $i); ?>>
                        <?php echo $i; ?>
                    </option>
                    <?php endfor; ?>
                </select>
    ...
    <div id="pedoni-feriti-container">
        <h5>
            <?php _e('Pedoni Feriti', 'incidenti-stradali'); ?>
        </h5>
        <?php for ($i = 1; $i <= 4; $i++): 
        ...
        <div id="pedone-ferito-<?php echo $i; ?>" class="pedone-section" style="display: <?php echo $display; ?>;">
            <h6>
                <?php printf(__('Pedone Ferito %d', 'incidenti-stradali'), $i); ?>
            </h6>
            <table class="form-table">
                <tr>
                    <th><label for="<?php echo $prefix; ?>eta">
                ...
                <tr>
                    ...
                    <td>
                        <select id="<?php echo $prefix; ?>sesso" name="<?php echo $prefix; ?>sesso">
                            ...
                            <option value="3" <?php selected($sesso, '3' ); ?>>
                                <?php _e('Maschio', 'incidenti-stradali'); ?>
                            </option>
                            <option value="4" <?php selected($sesso, '4' ); ?>>
                                <?php _e('Femmina', 'incidenti-stradali'); ?>
                            </option>
                        </select>
                    </td>
    ...
    <div id="pedoni-morti-container">
        <h5>
            <?php _e('Pedoni Morti', 'incidenti-stradali'); ?>
        </h5>
        <?php for ($i = 1; $i <= 4; $i++): 
        ...
        <div id="pedone-morto-<?php echo $i; ?>" class="pedone-section" style="display: <?php echo $display; ?>;">
            <h6>
                <?php printf(__('Pedone Morto %d', 'incidenti-stradali'), $i); ?>
            </h6>
            <table class="form-table">
                <tr>
                    <th><label for="<?php echo $prefix; ?>eta">
    ...
    <div class="incidenti-coordinate-container">
        ...
        <table class="form-table">
            <tr>
                <th><label for="latitudine">
                        <?php _e('Latitudine', 'incidenti-stradali'); ?> <span class="description">(°)</span></label></th>
                <td>
                    <input type="text" id="latitudine" name="latitudine" value="<?php echo esc_attr($latitudine); ?>" placeholder="es. 41.902783" class="incidenti-coordinate-input">
                </td>
            </tr>
            <tr>
                <th><label for="longitudine">
                        <?php _e('Longitudine', 'incidenti-stradali'); ?> <span class="description">(°)</span></label></th>
                <td>
                    <input type="text" id="longitudine" name="longitudine" value="<?php echo esc_attr($longitudine); ?>" placeholder="es. 12.496366" class="incidenti-coordinate-input">
                </td>
            </tr>
        </table>
    ...
    <div class="incidenti-circostanze-container">
        ...
        <h4>
            <?php _e('Per inconvenienti di circolazione', 'incidenti-stradali'); ?>
        </h4>
        <table class="form-table">
            <tr>
                <th><label for="circostanza_tipo">
                        <?php _e('Tipo di incidente', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="circostanza_tipo" name="circostanza_tipo">
                        <option value="">
                            <?php _e('Seleziona tipo', 'incidenti-stradali'); ?>
                        </option>
                        <option value="intersezione" <?php selected($circostanza_tipo, 'intersezione' ); ?>>
                            <?php _e('Incidente all\'intersezione stradale', 'incidenti-stradali'); ?>
                        </option>
                        <option value="non_intersezione" <?php selected($circostanza_tipo, 'non_intersezione' ); ?>>
                            <?php _e('Incidente non all\'intersezione', 'incidenti-stradali'); ?>
                        </option>
                        <option value="investimento" <?php selected($circostanza_tipo, 'investimento' ); ?>>
                            <?php _e('Investimento di pedone', 'incidenti-stradali'); ?>
                        </option>
                        <option value="urto_fermo" <?php selected($circostanza_tipo, 'urto_fermo' ); ?>>
                            <?php _e('Urto con veicolo fermo/ostacolo', 'incidenti-stradali'); ?>
                        </option>
                        <option value="senza_urto" <?php selected($circostanza_tipo, 'senza_urto' ); ?>>
                            <?php _e('Veicolo senza urto', 'incidenti-stradali'); ?>
                        </option>
                    </select>
                </td>
            </tr>
            <tr>
                <th><label for="circostanza_veicolo_a">
                        <?php _e('Circostanza Veicolo A', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="circostanza_veicolo_a" name="circostanza_veicolo_a">
                        <option value="">
                            <?php _e('Seleziona circostanza', 'incidenti-stradali'); ?>
                        </option>
            ...
            <tr>
                <th><label for="circostanza_veicolo_b">
                        <?php _e('Circostanza Veicolo B/Pedone', 'incidenti-stradali'); ?></label></th>
                <td>
        ...
        <h4>
            <?php _e('Per difetti o avarie del veicolo', 'incidenti-stradali'); ?>
        </h4>
        <table class="form-table">
            <tr>
                <th><label for="difetto_veicolo_a">
                        <?php _e('Veicolo A', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="difetto_veicolo_a" name="difetto_veicolo_a">
                        <option value="">
                            <?php _e('Nessun difetto', 'incidenti-stradali'); ?>
                        </option>
            ...
            <tr>
                <th><label for="difetto_veicolo_b">
                        <?php _e('Veicolo B', 'incidenti-stradali'); ?></label></th>
                <td>
        ...
        <h4>
            <?php _e('Per stato psico-fisico del conducente', 'incidenti-stradali'); ?>
        </h4>
        <table class="form-table">
            <tr>
                <th><label for="stato_psicofisico_a">
                        <?php _e('Conducente Veicolo A', 'incidenti-stradali'); ?></label></th>
                <td>
                    <select id="stato_psicofisico_a" name="stato_psicofisico_a">
                        <option value="">
                            <?php _e('Normale', 'incidenti-stradali'); ?>
                        </option>
            ...
            <tr>
                <th><label for="stato_psicofisico_b">
                        <?php _e('Conducente Veicolo B', 'incidenti-stradali'); ?></label></th>
                <td>
    ...
    <?php
        ...
        /**
         * Gestisce la richiesta AJAX per la stampa del modulo PDF
         */
        public function handle_stampa_modulo_pdf() {
            // Verifica nonce
            $post_id = intval($_GET['post_id']);
            if (!wp_verify_nonce($_GET['_nonce'], 'stampa_modulo_' . $post_id)) {
                wp_die(__('Richiesta non valida', 'incidenti-stradali'));
            }
            
            // Verifica permessi
            if (!current_user_can('edit_post', $post_id)) {
                wp_die(__('Non hai i permessi per questa operazione', 'incidenti-stradali'));
            }
            
            // Verifica che sia un incidente
            if (get_post_type($post_id) !== 'incidente_stradale') {
                wp_die(__('Post non valido', 'incidenti-stradali'));
            }
            
            // Genera il PDF
            $this->generate_pdf_modulo($post_id);
        }

        /**
         * Genera il PDF del modulo incidente
         */
        private function generate_pdf_modulo($post_id) {
            // Carica la libreria TCPDF (se non già inclusa)
            ...
            $pdf->SetTitle('Modulo Incidente Stradale - ' . $codice_ente);
            $pdf->SetSubject('Rilevazione Statistica Incidente Stradale');
            ...
            // Output del PDF
            $filename = 'modulo_incidente_' . $codice_ente . '_' . date('Y-m-d') . '.pdf';
            $pdf->Output($filename, 'I'); // 'I' = inline nel browser
            exit;
        }
        ...
        private function generate_pdf_content($post_id) {
            $data = $this->get_incidente_data($post_id);
            
            $html = '
            <style>
                body { font-family: "DejaVu Sans", sans-serif; font-size: 10pt; line-height: 1.3; }
                .header { text-align: center; margin-bottom: 20px; border-bottom: 2px solid #333; padding-bottom: 10px; }
                .logo { font-size: 16pt; font-weight: bold; color: #2c3e50; }
                .subtitle { font-size: 12pt; color: #7f8c8d; margin-top: 5px; }
                .codice { font-size: 14pt; font-weight: bold; background-color: #ecf0f1; padding: 8px; margin: 10px 0; text-align: center; border: 1px solid #bdc3c7; }
                .sezione { margin: 15px 0; border: 1px solid #ddd; }
                .sezione-header { background-color: #34495e; color: white; padding: 8px; font-weight: bold; font-size: 11pt; }
                .campo { display: inline-block; margin: 5px 0; padding: 3px 0; }
                .label { font-weight: bold; color: #2c3e50; display: inline-block; width: 150px; }
                .valore { color: #34495e; }
                .tabella { border-collapse: collapse; width: 100%; margin: 10px 0; }
                .tabella th, .tabella td { border: 1px solid #bdc3c7; padding: 6px; text-align: left; }
                .tabella th { background-color: #ecf0f1; font-weight: bold; }
                .vuoto { color: #95a5a6; font-style: italic; }
                .firma-box { border: 1px solid #bdc3c7; height: 60px; margin: 20px 0; text-align: center; padding-top: 25px; background-color: #f8f9fa; }
            </style>
            
            <div class="header">
                <div class="logo">RILEVAZIONE STATISTICA INCIDENTE STRADALE</div>
                <div class="subtitle">Modulo ISTAT - ' . date('Y') . '</div>
            </div>
            
            <div class="codice">Codice Identificativo: ' . esc_html($data['codice_ente']) . '</div>';
            
            // Sezione Dati Generali
            if (!empty(array_filter($data['dati_generali']))) {
                $html .= $this->generate_sezione_html('DATI GENERALI', $data['dati_generali']);
            }
            
            // Sezione Localizzazione
            if (!empty(array_filter($data['localizzazione']))) {
                $html .= $this->generate_sezione_html('LOCALIZZAZIONE', $data['localizzazione']);
            }
            
            // Sezione Veicoli (solo se presenti)
            foreach ($data['veicoli'] as $i => $veicolo) {
                if (!empty(array_filter($veicolo))) {
                    $html .= $this->generate_sezione_html('VEICOLO ' . chr(65 + $i), $veicolo);
                }
            }
            
            // Sezione Conducenti (solo se presenti)
            foreach ($data['conducenti'] as $i => $conducente) {
                if (!empty(array_filter($conducente))) {
                    $html .= $this->generate_sezione_html('CONDUCENTE ' . chr(65 + $i), $conducente);
                }
            }
            
            // Sezione Persone coinvolte (solo se presenti)
            if (!empty(array_filter($data['persone']))) {
                $html .= $this->generate_sezione_html('PERSONE COINVOLTE', $data['persone']);
            }
            
            // Sezione Circostanze (solo se presenti)
            if (!empty(array_filter($data['circostanze']))) {
                $html .= $this->generate_sezione_html('CIRCOSTANZE DELL\'INCIDENTE', $data['circostanze']);
            }
            
            $html .= '
            <div style="margin-top: 30px;">
                <div class="firma-box">
                    <strong>Firma del Rilevatore</strong>
                </div>
                <p style="font-size: 8pt; color: #7f8c8d; text-align: center; margin-top: 20px;">
                    Documento generato automaticamente il ' . date('d/m/Y H:i') . ' - Sistema Gestione Incidenti Stradali
                </p>
            </div>';
        ...
        /**
         * Genera HTML per una sezione del modulo
         */
        private function generate_sezione_html($titolo, $campi) {
            $html = '<div class="sezione">';
            $html .= '<div class="sezione-header">' . strtoupper($titolo) . '</div>';
            ...
            foreach ($campi as $label => $valore) {
                if (!empty($valore)) {
                    ...
                    $html .= '<span class="valore">' . esc_html($valore) . '</span>';
                    $html .= '</div><br>';
                }
            }
        ...
        /**
         * Estrae tutti i dati dell'incidente organizzati per sezioni
         */
        private function get_incidente_data($post_id) {
            // Qui implementi la logica per estrarre tutti i dati meta
            // e organizzarli in array strutturati
            
            return array(
                'codice_ente' => get_post_meta($post_id, 'codice__ente', true),
                'dati_generali' => array(
                    'Data Incidente' => get_post_meta($post_id, 'data_incidente', true),
                    'Ora' => get_post_meta($post_id, 'ora_incidente', true) . ':' . get_post_meta($post_id, 'minuti_incidente', true),
                    'Comune' => $this->get_nome_comune(get_post_meta($post_id, 'comune_incidente', true)),
                    'Ente Rilevatore' => get_post_meta($post_id, 'ente_rilevatore', true),
                    'Nome Rilevatore' => get_post_meta($post_id, 'nome_rilevatore', true),
                ),
                'localizzazione' => array(
                    'Tipo Strada' => $this->get_label_tipo_strada(get_post_meta($post_id, 'tipo_strada', true)),
                    'Denominazione' => get_post_meta($post_id, 'denominazione_strada', true),
                    'Numero Strada' => get_post_meta($post_id, 'numero_strada', true),
                    'Latitudine' => get_post_meta($post_id, 'latitudine', true),
                    'Longitudine' => get_post_meta($post_id, 'longitudine', true),
                ),
                'veicoli' => array(), // Da implementare
                'conducenti' => array(), // Da implementare
                'persone' => array(), // Da implementare
                'circostanze' => array() // Da implementare
            );
        }
}